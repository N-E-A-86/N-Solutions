      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <motion.span 
            ...
            className="text-[10px] font-bold text-indigo-500 tracking-[0.2em] uppercase mb-4 block"
          >
            PROCESO
          </motion.span>
          <motion.h2 
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full md:w-full h-[2px] md:h-[1px] bg-gradient-to-r from-indigo-500/0 via-indigo-500/50 to-indigo-500/0"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pt-12">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-[2px] h-full bg-gradient-to-b from-indigo-500/50 to-transparent md:hidden"></div>

                <div className="relative z-10 pl-6 md:pl-0">
                  <span 
                    className="text-7xl font-black absolute -top-12 left-0 transition-all duration-300 opacity-20 pointer-events-none select-none group-hover:opacity-100 group-hover:scale-110 text-indigo-400 group-hover:text-orange-600"
                    style={{
